...
base_url = 'https://kodepos.posindonesia.co.id/kecamatanlist'
params = {
    'recperpage': 100,
    'search': '',
}
...
with open('kecamatan.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)

    # Write the header row
    writer.writerow(['no', 'kode', 'nama', 'propinsi','kabupaten'])
    ...
    while True:
        ...
        rows = soup.select('#tbl_kecamatanlist tbody tr')
